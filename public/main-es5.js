...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 20,
      vars: 11,
      consts: [[1, "nav"], [1, "nav-item"], [1, "nav-link", "active", 3, "routerLink"], ["class", "nav-link active", 3, "routerLink", 4, "ngIf"], ["type", "button", "class", "btn btn-primary", "class", "dropdown-item", 3, "click", 4, "ngIf"], ["type", "button", 1, "dropdown-item", 3, "click"]],
